...
/*
	...
	wp_enqueue_style('style', get_template_directory_uri(). '/css/customMilton.css', array('style'));

	//wp_enqueue_style('styleMREC', get_template_directory_uri(). '/assets/src/css/customMilton.css', array('styleTheme'));
